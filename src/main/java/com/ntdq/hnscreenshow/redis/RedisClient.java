package com.ntdq.hnscreenshow.redis;
...
public class RedisClient {
    ...
    public boolean setHashAttribute(String key, String propertyKey, String value) {
        Long count = this.redis.hset(key, propertyKey, value);
        return count > 0;
    }
